...
import image1 from '../../product01.png'
import image2 from '../../product03.png'
import image3 from '../../product08.png'
                ...
                <div className="row row-producto-container">
                    ...
                    <div className="col-md-5">
                        <div className="product-details">
                            <h2 className="product-name">XBOX ONE FULL HD 4K 100% REAL NO FAKE UN LINK MEGA</h2>
                            <div>
                                ...
                                <a className="review-link">10 Comntario(s)</a>
                            </div>
                            <div>
                            ...
                            <div className="add-to-cart">
                                ...
                                <button className="add-to-cart-btn"><i className="fa fa-shopping-cart"></i> Agregar al carrito</button>
                            </div>
                    ...
                    <div className="col-md-12">
                        <div id="product-tab">
                            <ul className="tab-nav">
                                <li className="active"><a data-toggle="tab" >Reseñas (3)</a></li>
                            </ul>
