...
INSERT INTO producto(nombre_producto,descripcion,marca,precio,id_subcategoria, estado)
	VALUES('Xiaomi mi 9T','good phone','Xiaomi','300','5',1),
		('LG UHD','good tv','LG','500','11',1);
...
INSERT INTO comentario (comentario, calificacion, fecha, id_producto, id_usuario) VALUES
                         ('comentario de prueba', 'AB', '2019-02-18',1,4),
                         ('comentario de prueba', 'AB', '2019-02-18',1,5),
                         ('comentario de prueba', 'AB', '2019-02-18',1,6),
                         ('comentario de prueba', 'AB', '2019-02-18',2,4),
                         ('comentario de prueba', 'AB', '2019-02-18',2,5),
                         ('comentario de prueba', 'AB', '2019-02-18',1,4);
...
(
    ...
    INSERT INTO detalle_factura (id_factura,id_catalogo,id_producto, cantidad_comprada, precio_actual) VALUES
                                          (1,1,1,1,3200),
                                          (1,1,2,1,5100),
                                          (2,2,1,1,3300),
                                          (2,2,2,1,3100),
